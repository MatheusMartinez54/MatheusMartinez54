...
module.exports = async function handler(req, res) {
  try {
    ...
    const showTitle = searchParams.get('showTitle') || '1';
    ...
    const height = isCompact ? langsStart + languagePercent.length * line + 30 : langsStart + (languagePercent.length + 1) * line + 36;
